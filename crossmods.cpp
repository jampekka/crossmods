...
.def(py::init<double, double, double, double, double, double>(), "thm"_a, "ths"_a, "lagm"_a, "lags"_a, "passm"_a, "passs"_a)
.def("decisions", (::crossmods::CrossingPdf & ( ::crossmods::LognormalTdm::* )( ::crossmods::CrossingPdf &,::crossmods::invec )const) &::crossmods::LognormalTdm::decisions, "out"_a, "taus"_a)
.def("decisions", (::std::unique_ptr<crossmods::CrossingPdf, std::default_delete<crossmods::CrossingPdf> > ( ::crossmods::LognormalTdm::* )( ::crossmods::invec,double )const) &::crossmods::LognormalTdm::decisions, "taus"_a, "dt"_a)
...
.def(py::init<double, double, double, double, double, double, double>(), "dt"_a, "std"_a, "damping"_a, "tau_threshold"_a, "pass_threshold"_a=0., "scale"_a=1., "act_threshold"_a=1.)
